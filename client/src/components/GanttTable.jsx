  ...
  return (
    <div style={{ marginTop: '12px' }}>
      ...
      <div style={{ border: `1px solid ${colors.border}`, borderRadius: '14px', overflow: 'hidden', background: colors.surface }}>
        <div style={{ display: 'grid', gridTemplateColumns: '24px 40px 220px 90px 150px 110px 110px 1fr', background: colors.bg, borderBottom: `1px solid ${colors.border}` }}>
          <div />
          <div style={headerCellStyle}>#</div>
          <div style={headerCellStyle}>Fase/Tarea/Subtarea</div>
          <div style={headerCellStyle}>Duración</div>
          <div style={headerCellStyle}>Dependencia</div>
          <div style={headerCellStyle}>Fecha inicio</div>
          <div style={headerCellStyle}>Fecha fin</div>
          <div style={{ ...headerCellStyle, overflowX: 'auto' }}>
        ...
        {scheduled.map((t, i) => {
          ...
          return (
            <div
              ...
              style={{
                display: 'grid',
                gridTemplateColumns: '24px 40px 220px 90px 150px 110px 110px 1fr',
            ...
            >
              ...
              <div style={{ padding: '10px 12px', fontFamily: fonts.body, fontSize: '14px', color: colors.textMuted, fontWeight: 600 }}>
                {numbers[i]}
              </div>
              ...
              <div style={{ padding: '10px 12px' }}>
                <input
                  ...
                  min={1}
                  value={t.duration}
                  onChange={(e) => onUpdateTask(i, { duration: Number(e.target.value) || 1 })}
              ...
              <div style={{ padding: '10px 12px', fontFamily: fonts.body, fontSize: '14px', color: colors.textMuted }}>
                {offsetDateStr(t.start)}
              </div>
              <div style={{ padding: '10px 12px', fontFamily: fonts.body, fontSize: '14px', color: colors.textMuted }}>
                {offsetDateStr(t.end)}
              </div>
              <div style={{ padding: '10px 12px', position: 'relative', height: '28px' }}>
                <div
                  style={{
                    position: 'absolute',
                    top: 0,
